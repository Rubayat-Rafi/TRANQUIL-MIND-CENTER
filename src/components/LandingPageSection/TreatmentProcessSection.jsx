...
const TreatmentProcessSection = () => {
  ...
  const steps = [
    {
      ...
      title: "Consultation",
      description:
        "We meet with you to discuss symptoms, treatment history, and determine if TMS is right for you.",
      icon: MessageSquare,
    ...
    },
    {
      ...
      title: "Motor Mapping",
      description:
        "Your motor threshold is measured to individualize your treatment settings.",
      icon: Brain,
    ...
    },
    {
      ...
      description:
        "You will visit the clinic Monday–Friday for 4–6 weeks. Each session lasts 20–45 minutes.",
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "Weekly check-ins ensure improvement and allow protocol adjustments when needed.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Some patients receive monthly boosters to maintain long-term results.",
      icon: RefreshCw,
  ...
  return (
    <section className="py-16 lg:py-24  bg-secondary-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="max-w-[1440px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 relative z-10">
        {/* Section Header */}
        <div className="text-center mb-12 lg:mb-20">
          ...
          <p className="text-base lg:text-xl text-secondary-text max-w-3xl mx-auto">
            A clear, structured path from your first consultation to lasting
            relief
          </p>
        </div>
                ...
                return (
                  <div key={index} className="relative">
                    ...
                    <div className="group relative bg-background rounded-3xl p-6 border-2 border-primary/10 hover:border-primary/30 transition-all hover:shadow-2xl hover:-translate-y-2">
                      ...
                      {/* Icon */}
                      <div
                        className={`w-20 h-20 bg-linear-to-br ${step.color} rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform shadow-lg`}
                      >
                      ...
                      {/* Timeline Dot */}
                      <div
                        className={`absolute -bottom-12 left-1/2 -translate-x-1/2 w-6 h-6 bg-linear-to-br ${step.color} rounded-full border-4 border-background shadow-lg`}
                      ></div>
                    </div>
                    ...
                    {index < steps.length - 1 && (
                      <div className="absolute top-1/2 -right-2 translate-x-1/2 -translate-y-1/2 z-20">
                        <div
                          className={`w-8 h-8 bg-linear-to-br ${step.color} rounded-full flex items-center justify-center shadow-lg`}
                        >
              ...
              <div key={index} className="relative">
                ...
                <div className="relative bg-background rounded-3xl p-6 border-2 border-primary/10 hover:border-primary/30 transition-all">
                  <div className="flex gap-6">
                    ...
                    <div className="shrink-0">
                      <div
                        className={`w-16 h-16 bg-linear-to-br ${step.color} rounded-2xl flex items-center justify-center shadow-lg relative`}
                      >
                ...
                {index < steps.length - 1 && (
                  <div className="flex justify-center my-4">
                    <div
                      className={`w-10 h-10 bg-linear-to-br ${step.color} rounded-full flex items-center justify-center shadow-lg`}
                    >
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 mt-16 lg:mt-24">
          <div className="bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl p-6 lg:p-8 border border-primary/20">
            ...
            <h4 className="text-lg lg:text-xl font-bold text-text mb-2">
              Typical Timeline
            </h4>
            <p className="text-sm lg:text-base text-secondary-text">
              4–6 weeks of daily sessions, Monday through Friday
            </p>
          </div>
          ...
          <div className="bg-linear-to-br from-accent/10 to-accent/5 rounded-2xl p-6 lg:p-8 border border-accent/20">
            ...
            <p className="text-sm lg:text-base text-secondary-text">
              Each treatment session lasts 20–45 minutes
            </p>
          </div>
          ...
          <div className="bg-linear-to-br from-second-primary/10 to-second-primary/5 rounded-2xl p-6 lg:p-8 border border-second-primary/20">
            ...
            <p className="text-sm lg:text-base text-secondary-text">
              Optional maintenance sessions available for sustained results
            </p>
          </div>
        </div>
          ...
          <div className="inline-block bg-linear-to-r from-primary via-accent to-second-primary p-1 rounded-3xl">
            <div className="bg-background rounded-[22px] px-8 lg:px-12 py-8 lg:py-10">
              ...
              <p className="text-base lg:text-lg text-secondary-text mb-6">
                Schedule your free consultation and we&apos;ll guide you through
                every step
              </p>
              <Link href={'/schedule'} className="px-8 py-4 bg-linear-to-r from-primary to-second-primary hover:from-second-primary hover:to-primary text-white font-semibold rounded-full transition-all hover:scale-105 shadow-lg">
